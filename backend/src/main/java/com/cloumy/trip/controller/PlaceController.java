...
public class PlaceController {
    ...
    // "직접 장소 추가" — 카테고리 필터 없는 일반 카카오 검색
    @GetMapping("/search")
    public ApiResponse<List<KakaoPlaceDto>> searchPlaces(@RequestParam String keyword) {
        return ApiResponse.ok(placeService.searchPlaces(keyword));
    }
