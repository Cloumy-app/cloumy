...
| ~~`architecture.svg`~~ | 다이어그램 | ✅ **삭제됨(2026-08-27).** `02-architecture.md`·`README.md`의 Mermaid로 대체 — GitHub 렌더 + diff 가능 |
...
> **❌ 없음.** 마지막 하나였던 `architecture.svg`는 2026-08-27에 삭제하고 Mermaid로 대체했다.
