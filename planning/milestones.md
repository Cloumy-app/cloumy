...
**[Frontend UX + AI 품질 — 중간 점검 후속 (2026-06-29)]**
- [ ] 전체보기 라우팅 버그 수정 + 내 루트 목록 화면 (`app/routes/index.tsx`)
- [x] 루트 생성 날짜 선택 UI — step-1 출발일 DatePicker — 2026-06-30
- [ ] 루트 저장 완료 피드백 토스트
- [ ] 루트 결과 화면 일별 예상 비용 합계 표시
- [ ] 루트 결과 화면 날씨 정보 표시 (OpenWeatherMap)
- [ ] 프로필 화면 구현 (닉네임 + 내 루트 목록 연결)
